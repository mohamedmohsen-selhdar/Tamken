              ...
              <div className={`glass-panel p-6 rounded-industrial border mb-8 animate-fade-in ${editingId ? 'border-primary/50' : 'border-border'}`}>
                ...
                <form onSubmit={editingId ? handleUpdateSubmit : handleAddSubmit} className="grid gap-4 md:grid-cols-2">
                  {activeTab === 'articles' && (<>
                    ...
                    <div className="md:col-span-2"><label className="block text-sm mb-1 text-muted-foreground">Cover Image URL (e.g. Google Drive, Imgur, Unsplash)</label><input type="text" value={articleForm.imageUrl} onChange={e => setArticleForm({...articleForm, imageUrl: e.target.value})} placeholder="https://..." className="w-full bg-background border border-border rounded-md px-3 py-2" /></div>
                  ...
                  {activeTab === 'casestudies' && (<>
                    ...
                    <div className="md:col-span-2"><label className="block text-sm mb-1 text-muted-foreground">Case Study Image URL (e.g. Google Drive, Imgur, Unsplash)</label><input type="text" value={caseStudyForm.imageUrl} onChange={e => setCaseStudyForm({...caseStudyForm, imageUrl: e.target.value})} placeholder="https://..." className="w-full bg-background border border-border rounded-md px-3 py-2" /></div>
                  </>)}
                  {activeTab === 'careers' && (<>
